...
import shoptop from "../assets/shoptop.jpg";
import shoptop2 from "../assets/shoptop2.jpg";
import shoptop3 from "../assets/shoptop3.jpg";
import shoptop5 from "../assets/shoptop5.webp";
...
import trend8 from "../assets/trend8.avif";
...
const categories = [
    ...
    },
    {
        ...
        name: "Footwear",
        imageUrl: footwear,
        subcategories: ["Heels", "Crocs", "Slippers", "Shoes", "Boots"],
    },
    {
        id: 5,
        name: "Accessories",
        imageUrl: accessories,
        subcategories: ["Rings", "Bracelets", "Bags", "Necklaces", "Earings"],
    },
];
        ...
        <>
            <div className="shop-container">
                ...
                >
                    ...
                    <IconButton
                        className={
                            "trending-slider-btn trending-slider-btn-left"
                        }
                        sx={{
                    ...
                    <IconButton
                        className={
                            "trending-slider-btn trending-slider-btn-right"
                        }
                        sx={{
                            backgroundColor: "black",
                            color: "white",
