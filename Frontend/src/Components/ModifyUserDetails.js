...
const ModifyUserDetails = () => {
    ...
    const handleDelete = (userId) => {
        ...
        axios
            .delete(`${domain}/delete-user/${userId}`)
            .then((response) => {
    ...
    const handleSave = (userId) => {
        if (editingUser && editingUser._id === userId) {
            axios
                .patch(`${domain}/user-details-update/${userId}`, editingUser)
                .then(() => {
                    setUsers(
                        users.map((user) =>
                            user._id === userId ? editingUser : user
                        )
                    );
                    setEditingUser(null);
