...
function SellingForm() {
    ...
    const handleSubmit = () => {
        ...
        axios
            .post(`${domain}/api/product/user-selling-form`, formData)
            .then((response) => {
    ...
    return (
        <>
            ...
            /> */}
                        <Textarea
                            name="Outlined"
                            placeholder="Desciption of Product"
                            variant="outlined"
                            minRows={3}
                            sx={{ width: 300, marginTop: 2 }}
                            onChange={(event) =>
                        ...
                        <Textarea
                            name="Outlined"
                            placeholder="Reason for Re-Selling"
                            variant="outlined"
                            minRows={3}
                            sx={{ width: 300, marginTop: 2, marginBottom: 3 }}
                            onChange={(event) =>
                                setReasonForReselling(event.target.value)
                            }
                        />
                    </div>
                    <div
                    ...
                    >
                        ...
                        >
                            ...
                            <TextField
                                ...
                                variant="outlined"
                                sx={{ width: "48%", marginTop: 2 }}
                                onChange={handleResellingPriceChange}
                            />
                        </div>
